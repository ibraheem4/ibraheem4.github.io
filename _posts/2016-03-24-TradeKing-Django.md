...
- finance
- python
modified: 	2016-11-01T00:00:00-07:00+00:00
comments: 	true
---
...
I wanted to build a light-weight Django project around these API calls and to make the application available on [PyPI](https://pypi.python.org/pypi) as a [Package](https://packaging.python.org/en/latest/distributing/#uploading-your-project-to-pypi).

Full version: [django-tradeking](https://github.com/ibraheem4/django-tradeking)