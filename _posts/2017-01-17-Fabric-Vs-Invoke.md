...
Similar to Ruby's [Rake](https://github.com/ruby/rake) tool, Python has tools for running shell commands and defining/organizing tasks.  My personal favorite of the bunch is [Fabric](www.fabfile.org/), but for those using Python 3, you can consider using [Invoke](www.pyinvoke.org).  These tools provide high level APIs for task execution.
