...
We're going to put together a basic web application using Rails, describing the app in terms Features and of [User Stories](http://www.agilemodeling.com/artifacts/userStory.htm).  Off we go!
